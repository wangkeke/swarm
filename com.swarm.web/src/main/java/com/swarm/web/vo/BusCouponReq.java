...
@Getter
@Setter
public class BusCouponReq extends CreateReq<BusCoupon> {
	...
	@Override
	public BusCoupon create() {
		BusCoupon busCoupon = new BusCoupon();
		busCoupon.setUpdateDate(new Date());
		busCoupon.setCreateDate(new Date());
		...
		busCoupon.setBusUserId(CurrentUser.getBusUserId());
		return busCoupon;
	}
