...
@Getter
@Setter
public class SysDictReq extends CreateReq<SysDict> {
	...
	@Override
	public SysDict create() {
		SysDict sysDict = new SysDict();
		sysDict.setCreateDate(new Date());
		sysDict.setDesc(this.desc);
		sysDict.setKey(this.key);
		if(this.sort!=null) {			
			sysDict.setSort(this.sort);
		}
		sysDict.setType(this.type);
		sysDict.setUpdateDate(new Date());
		sysDict.setValue(this.value);
		sysDict.setValue2(this.value2);
		return sysDict;
	}
